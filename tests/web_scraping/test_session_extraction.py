...
def test_extract_and_write_session_data(
    ...
    mock_get_motogp_classification_url.assert_called_once_with(
        url=f"https://www.motogp.com/en/gp-results/2025/spa/motogp/{input_session}/classification"
    )
    ...
    mock_write_session_data.assert_called_once_with(
        data=ANY, output_file_path=f"data/2025/round_4/{session_full_name}.json"
    )
